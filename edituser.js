function saveToLocalStorage(event){
    ...
    axios.post("https://crudcrud.com/api/963eae9226a4480c923648a3d317cfe8/appointmentData",userData)
    .then((response) => {
...
window.addEventListener("DOMContentLoaded", ()=> {
    axios.get("https://crudcrud.com/api/963eae9226a4480c923648a3d317cfe8/appointmentData")
        .then((response) => {
            console.log(response)
...
function showUserOnScreen(userData){
   ...
   function deleteUser(userId){
       axios.delete(`https://crudcrud.com/api/963eae9226a4480c923648a3d317cfe8/appointmentData/${userId}`)
           .then((response) => {
